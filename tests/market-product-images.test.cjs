...
assert.match(architectureCss,/\.cdc-product-image img[\s\S]*object-fit:contain!important/,'release must preserve uncropped verified product photos');

// index.html is the source template; prepare-pages expands the production CSP.
...
console.log('Market real/official images remain isolated and visible under the v76 release architecture: OK');
