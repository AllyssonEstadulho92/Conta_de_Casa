...
try {
  ...
  assert.ok(index.indexOf('v74-experience.js?v=74-experience2') < index.indexOf('v75-architecture.js?v=75-architecture1'));
  assert.ok(index.indexOf('mobile-menu-toggle.css?v=73-menu8') < index.indexOf('v74-experience.css?v=74-experience2'));
  assert.ok(index.indexOf('v74-experience.css?v=74-experience2') < index.indexOf('v75-architecture.css?v=75-architecture1'));
