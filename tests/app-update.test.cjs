...
try {
  ...
  assert.ok(index.indexOf('mobile-menu-toggle.js?v=73-menu8') < index.indexOf('v75-architecture.js?v=76-architecture-unblock6'));
  assert.ok(index.indexOf('v75-architecture.js?v=76-architecture-unblock6') < index.indexOf('v75-stability.js?v=75-stability1'));
