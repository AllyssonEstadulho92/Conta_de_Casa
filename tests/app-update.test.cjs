...
assert.match(updateJs, /version:'v62'/);
assert.match(updateJs, /Fotografia do retalhista sem misturas/);
...
try {
  ...
  assert.match(index, /id="appBuildVersion">v62</);
  assert.match(events, /\.\/sw\.js\?v=62/);
