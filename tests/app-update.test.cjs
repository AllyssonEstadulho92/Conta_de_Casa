...
try {
  ...
  assert.match(index, /invoice-capture\.css\?v=76-invoice-native4/);
  assert.match(index, /invoice-capture\.js\?v=76-invoice-native4/);
  assert.match(events, /\.\/sw\.js\?v=76-safe-refresh3/);
