...
assert.match(menuJs,/Conta de Casa v73/,'the proven drawer/swipe controller remains the v73 runtime');
assert.match(menuCss,/Conta de Casa v76/,'the visible menu presentation belongs to the v76 shell');
assert.match(menuCss,/v76 menu-morph1/,'the v76 two-line to X morph must remain present');
...
assert.match(sw, /menu-morph1/,'the PWA cache must invalidate when the visible menu morph changes');
