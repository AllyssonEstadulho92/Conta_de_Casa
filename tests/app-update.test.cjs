...
try {
  ...
  assert.match(events, /\.\/sw\.js\?v=76-month-sync1/);
  ...
  assert.ok(index.indexOf('mobile-menu-toggle.js?v=73-menu8') < index.indexOf('v75-architecture.js?v=76-month-sync1'));
  assert.ok(index.indexOf('v75-architecture.js?v=76-month-sync1') < index.indexOf('v75-stability.js?v=75-stability1'));
