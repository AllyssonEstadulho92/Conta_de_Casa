...
for(const marker of ['id="appSidebar"','id="sidebarToggle"','id="mobileMenuBtn"','id="mobileDrawer"','id="drawerNav"','id="mobileNav" class="mobile-nav"','id="vaultPinPad"','data-pin-key="1"','id="vaultKeyboardModeToggle"','id="kpiGrid" class="kpi-grid dashboard-kpis"','id="dashboardSecondary" class="dashboard-secondary"','class="bill-command-bar"','id="billsList" class="bill-results"','class="bill-filter-grid"','class="market-command-bar"','id="marketList" class="market-results"','id="marketStatusFilter"'])assert.ok(index.includes(marker),`missing ${marker}`);
...
assert.match(swSource,/conta-de-casa-public-v58-official-images/);
...
assert.match(swSource,/'\.\/market-image-resolver\.js'/);
