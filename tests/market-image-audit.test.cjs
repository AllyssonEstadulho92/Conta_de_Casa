...
try{
  ...
  assert.match(index,/market-image-audit\.css\?v=66/);
  assert.match(index,/market-retailer-image-policy\.js\?v=66/);
  assert.match(index,/market-image-audit\.js\?v=66/);
  assert.match(index,/market-official-images\.js\?v=66/);
...
console.log('Market official retailer image, fallback, safe-source, zoom and v66 shell build tests: OK');
