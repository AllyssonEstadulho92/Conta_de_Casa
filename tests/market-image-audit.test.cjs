...
try{
  ...
  assert.match(index,/market-image-audit\.css\?v=67/);
  assert.match(index,/market-retailer-image-policy\.js\?v=67/);
  assert.match(index,/market-image-audit\.js\?v=67/);
  assert.match(index,/market-official-images\.js\?v=67/);
...
console.log('Market official retailer image, fallback, safe-source, zoom and v67 menu build tests: OK');
