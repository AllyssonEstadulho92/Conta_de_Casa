...
assert.match(sw,/date-calculator-layout2/,'O cache PWA deve invalidar a autoridade visual anterior.');
...
console.log('Date calculator: exact civil calculations + canonical responsive layout contract: OK');
