...
try{
  ...
  assert.ok(index.indexOf('market-shopping-focus.css')<index.indexOf('mobile-menu-toggle.css'),'v72 global menu CSS may load after the preserved v65 market-specific layer');
