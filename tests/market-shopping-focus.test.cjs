...
assert.match(sw,/76-architecture-unblock6/);
...
try{
  ...
  assert.match(index,/v75-architecture\.css\?v=76-architecture-unblock6/);
  assert.match(index,/v76-planning-more\.css\?v=76-planning-more1/);
  assert.match(index,/v75-architecture\.js\?v=76-architecture-unblock6/);
