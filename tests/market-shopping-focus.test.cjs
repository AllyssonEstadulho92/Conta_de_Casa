...
try{
  ...
  assert.ok(index.indexOf('market-shopping-focus.css')<index.indexOf('mobile-menu-toggle.css'),'v71 global menu CSS may load after the preserved v65 market-specific layer');
  ...
  assert.ok(index.indexOf('market-shopping-focus.js')<index.indexOf('mobile-menu-toggle.js'),'v71 menu controller must run after the preserved v65 shopping layer');
...
console.log('v65 mobile shopping focus preserved under the v71 menu release: OK');
