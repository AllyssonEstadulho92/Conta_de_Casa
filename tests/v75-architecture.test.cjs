...
assert.match(js,/76-budget-bill-month1/,'planning month-context hierarchy must remain explicit');
...
assert.match(prepare,/const SERVICE_WORKER_REV = '76-budget-bill-month1'/,'service worker URL must change for this physical iOS fix');
