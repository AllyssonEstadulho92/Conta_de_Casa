...
/* Conta de Casa v76 — estabilidade transversal de apresentação.
 ...
 * - mantém esta camada estritamente visual e sem acesso ao estado financeiro.
 *
 * Não lê nem escreve valores financeiros, IndexedDB, cofre ou sincronização.
 */
(function installV76Stability(root){
  ...
  const domObserver=new MutationObserver(records=>{
    ...
    for(const record of records){
      if(record.type==='childList'&&record.addedNodes.length)needsAudit=true;
