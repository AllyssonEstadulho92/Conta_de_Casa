...
/* Bundle público v75: mantém a experiência v74 como base funcional de apresentação,
   ...
   carregador prioritário de fotografias, drawer petróleo/teal à direita e uma camada
   transversal de usabilidade móvel sem alterar regras financeiras ou segurança.
