...
const DASHBOARD_REV = '76-security-network-copy1';
const FINANCE_REV = '76-budget-bill-month1';
const MOBILE_SHELL_REV = '76-mobile-shell3';
const ARCHITECTURE_REV = '76-budget-bill-month1';
...
const SERVICE_WORKER_REV = '76-budget-bill-month1';
...
if(!index.includes('v76-planning-more.css'))index=index.replace('</head>',`  <link rel="stylesheet" href="./v76-planning-more.css?v=${PLANNING_MORE_REV}" />\n</head>`);
