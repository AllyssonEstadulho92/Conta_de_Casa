...
4. **Navegação e páginas precisam de uma hierarquia estável**
   - A navegação principal deve continuar rasa e previsível: Início, Despesas, Mercado, Planeamento e Mais no mobile.
   - O drawer deve conter os destinos secundários sem duplicar controladores.
...
5. Rever todas as 10 rotas em mobile/desktop e manter CI, TypeScript e Pages obrigatoriamente verdes após cada bloco.
