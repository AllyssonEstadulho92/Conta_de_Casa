...
function renderSecurity() {
  ...
  setHTML('#securityPolicyList', `<div class="stack-list compact"><div class="list-row"><div class="list-main"><strong>Rede restrita</strong><small>Sem trackers, anúncios ou telemetria. A sincronização usa api.github.com e recebe somente o envelope cifrado. O leitor QR pode carregar ZXing 0.2.0 de unpkg.com, sem credenciais e sob a política CSP da aplicação. As pesquisas iniciadas pelo utilizador em Mercado podem consultar apenas as origens autorizadas pela CSP; nenhum dado financeiro do cofre é enviado.</small></div></div><div class="list-row"><div class="list-main"><strong>Sem dados em URL</strong><small>A navegação usa apenas secções conhecidas da aplicação.</small></div></div><div class="list-row"><div class="list-main"><strong>Sem anexos reais</strong><small>A estrutura existe, mas ficheiros continuam bloqueados até cifragem dedicada.</small></div></div></div>`);
