...
function marketVarianceHtml(item) {
  ...
  const diff=sumCents([marketItemActualCents(item),-marketItemEstimatedCents(item)]);
...
function renderSecurity() {
  ...
  setHTML('#securityPolicyList', `<div class="stack-list compact"><div class="list-row"><div class="list-main"><strong>Rede restrita</strong><small>Sem CDN de scripts, trackers, anúncios ou telemetria. O leitor ZXing é servido localmente pela própria aplicação. A sincronização usa api.github.com e recebe apenas o envelope cifrado. As pesquisas e imagens iniciadas pelo utilizador em Mercado podem consultar cesta.pt, r.jina.ai, Open Food Facts e os hosts oficiais das lojas; nenhum dado financeiro do cofre é enviado nesses pedidos.</small></div></div><div class="list-row"><div class="list-main"><strong>Sem dados em URL</strong><small>A navegação usa apenas secções conhecidas da aplicação.</small></div></div><div class="list-row"><div class="list-main"><strong>Sem anexos reais</strong><small>A estrutura existe, mas ficheiros continuam bloqueados até cifragem dedicada.</small></div></div></div>`);
